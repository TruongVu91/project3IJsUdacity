...
async function handleCreateRace() {
	...
	if(playerId !== undefined && trackId !== undefined) {
		...
		alert("Please select your track and racer")
	}
...
async function runRace(raceID) {
	...
	// remember to add error handling for the Promise
		...
		console.log("Problem with runRace")
	}
}
...
function handleAccelerate() {
	try {
		...
		console.log("Problem with handleAccelerate")
	 }
}
...
async function startRace(id) {
	...
	//POST request doesn't return anything
	//.then(res => res.json())
	.catch(err => console.log("Problem with startRace::", err))
}
...
function accelerate(id) {
	...
	//POST request doesn't return data
	//.then(res => res.json())
